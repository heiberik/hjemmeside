...
const captions = document.querySelectorAll(".image-list figcaption p");
const myArray = [];
...
photosCounter.textContent = captions.length;
...
for (const caption of captions) {
    myArray.push({
        id: counter++,
        text: caption.textContent.toLowerCase()
    });

}

searchInput.addEventListener("keyup", tastTrykk);
